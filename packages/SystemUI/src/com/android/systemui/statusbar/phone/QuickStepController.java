...
public class QuickStepController implements GestureHelper {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mNavigationBarView.isDt2s() && isDoubleTapPending) {
                    ...
                    if (isDoubleTapReally) LiquidUtils.switchScreenOff(mContext);
                } else {
            ...
            case MotionEvent.ACTION_UP:
               if (mNavigationBarView.isFullGestureMode()) {
                    ...
                    if (mBackActionScheduled) {
                        LiquidUtils.sendKeycode(KeyEvent.KEYCODE_BACK, mHandler);
                    } else {
                        endQuickScrub(true /* animate */);
                    }
                    break;
    ...
    private Runnable mDoubleTapCancelTimeout = new Runnable() {
        ...
        public void run() {
            ...
            mHandler.removeCallbacksAndMessages(null);
            LiquidUtils.sendKeycode(KeyEvent.KEYCODE_HOME, mHandler);
        }
    };
    ...
    private void moveKbCursor(boolean right, boolean firstTrigger) {
        ...
        LiquidUtils.moveKbCursor(KeyEvent.ACTION_UP, right);
        LiquidUtils.moveKbCursor(KeyEvent.ACTION_DOWN, right);
